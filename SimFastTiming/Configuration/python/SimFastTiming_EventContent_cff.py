...
premix_stage2.toModify(_phase2_timing_extraCommands,
    value = [ 'keep *_mixData_FTLBarrel_*','keep *_mixData_FTLBarrelSoA_*','keep *_mixData_FTLEndcap_*','keep *_mixData_FTLEndcapSoA_*','keep *_mix_InitialVertices_*', 'keep *_mtdRecoClusterToSimLayerClusterAssociation_*_*', 'keep *_mtdSimLayerClusterToTPAssociation_*_*' ]
)
